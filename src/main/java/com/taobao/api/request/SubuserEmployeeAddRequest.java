...
public class SubuserEmployeeAddRequest
        extends BaseTaobaoRequest<SubuserEmployeeAddResponse> {
    ...
    public void check() throws ApiRuleException {
        ...
        RequestCheckUtils.checkNotEmpty(this.employeeName, "employeeName");
