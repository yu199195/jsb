...
public class FenxiaoProductSkuAddRequest
        extends BaseTaobaoRequest<FenxiaoProductSkuAddResponse> {
    ...
    public void check() throws ApiRuleException {
        ...
        RequestCheckUtils.checkMaxValue(this.quantity, 1000000L, "quantity");
